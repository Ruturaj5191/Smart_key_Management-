...
export default function NavBar() {
  ...
  if (isAdmin) {
    links.push(
      ...
      { to: "/admin/parking", label: "🅿️ Parking" },
      { to: "/admin/visitor-reports", label: "👤 Visitors" },
      { to: "/admin/ai-alerts", label: "🤖 AI Alerts" },
    );
  }
  ...
  if (isOwner) {
    links.push(
      ...
      { to: "/owner/parking", label: "🅿️ Parking" },
      { to: "/owner/visitors", label: "👤 Visitors" },
      { to: "/owner/ai-chat", label: "🤖 AI Chat" },
    );
  }
  ...
  if (isSecurity) {
    links.push(
      ...
      { to: "/security/parking", label: "🚗 Parking" },
      { to: "/security/visitor-check", label: "👤 Visitors" },
    );
  }
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              {isAdmin && (
                <>
                  ...
                  <NavLink to="/admin/parking" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>🅿️ Parking</NavLink>
                  <NavLink to="/admin/visitor-reports" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>👤 Visitors</NavLink>
                  <NavLink to="/admin/ai-alerts" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>🤖 AI Alerts</NavLink>
                </>
              )}
              ...
              {isOwner && (
                <>
                  ...
                  <NavLink to="/owner/parking" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>🅿️ Parking</NavLink>
                  <NavLink to="/owner/visitors" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>👤 Visitors</NavLink>
                  <NavLink to="/owner/ai-chat" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>🤖 AI Chat</NavLink>
                </>
              )}
              ...
              {isSecurity && (
                <>
                  ...
                  <NavLink to="/security/parking" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>🚗 Parking</NavLink>
                  <NavLink to="/security/visitor-check" className={({ isActive }) => cx("rounded-lg px-3 py-2 text-sm font-medium transition-all", isActive ? "bg-white/10 text-white" : "text-slate-400 hover:bg-white/5 hover:text-slate-200")}>👤 Visitors</NavLink>
                </>
              )}
            </nav>
          </div>
