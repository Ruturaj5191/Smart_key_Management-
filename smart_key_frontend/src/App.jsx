...
import ParkingEntry from "./pages/security/ParkingEntry";
import VisitorGateCheck from "./pages/security/VisitorGateCheck";

// owner — new modules
import ParkingBooking from "./pages/owner/ParkingBooking";
import VisitorPreApprove from "./pages/owner/VisitorPreApprove";
import AIChat from "./pages/owner/AIChat";

// admin — new modules
import ParkingDashboard from "./pages/admin/ParkingDashboard";
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        <Routes>
          ...
          <Route path="/security/parking" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.SECURITY]}><ParkingEntry /></RoleRoute></ProtectedRoute>
          } />
          <Route path="/security/visitor-check" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.SECURITY]}><VisitorGateCheck /></RoleRoute></ProtectedRoute>
          } />

          {/* ── New Modules: Owner ──────────────────── */}
          <Route path="/owner/parking" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.OWNER]}><ParkingBooking /></RoleRoute></ProtectedRoute>
          } />
          <Route path="/owner/visitors" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.OWNER]}><VisitorPreApprove /></RoleRoute></ProtectedRoute>
          } />
          <Route path="/owner/ai-chat" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.OWNER]}><AIChat /></RoleRoute></ProtectedRoute>
          } />

          {/* ── New Modules: Admin ──────────────────── */}
          <Route path="/admin/parking" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.ADMIN, ROLE.SUPER_ADMIN]}><ParkingDashboard /></RoleRoute></ProtectedRoute>
          } />
          <Route path="/admin/visitor-reports" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.ADMIN, ROLE.SUPER_ADMIN]}><VisitorReports /></RoleRoute></ProtectedRoute>
          } />
          <Route path="/admin/ai-alerts" element={
            <ProtectedRoute><RoleRoute allowed={[ROLE.ADMIN, ROLE.SUPER_ADMIN]}><AIAlerts /></RoleRoute></ProtectedRoute>
          } />
